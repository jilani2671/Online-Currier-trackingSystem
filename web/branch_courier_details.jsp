            ...
            .button
{
    ...
    <body>
        <form action="branch_courier_details" name="branch_courier_details" method="post">
        ...
        <%
            ...
            String sql = "select * from user_courierinformation where Consignment_No = '"+session.getAttribute("Consignment_No")+"' ";
         ...
         <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-sm-3"><input type="text" class="textbox" name="Quantity" value="<%=rs.getString("Quantity")%>"></div>
              ...
              <div class="col-sm-3"><input type="text" class="textbox" name="Parcel_Type" value="<%=rs.getString("Parcel_Type")%>">
                    </div>  
         </div><br><br>
          <div class="row">
