              ...
              if(event.equals("Submit"))
        {
            ...
            else
            {
                try
                {
                    ...
                    String sql = "select * from  branch_signup where Email_ID='"+Email_ID+"'  && Password='"+Password+"'  ";
                     ResultSet rs = st.executeQuery(sql);
                    
                    if(rs.next())
                    {
                         session.setAttribute("branch_name",rs.getString("First_name"));
                        ...
                        out.println("location=' branch_home.jsp'");
                        out.println("</script>");
